...
import { AddCart, GetProductsId, GetUserId } from '../../../Redux/ApiSlice/Tunk/Tunk'
...
function Product() {
 ...
 const usercart =cart.Cart
  ...
  const Handle =  () => {
    if (uid) {
      const carts = [...usercart, { ...product, count }]
 ...
 const  HandleCart =()=>{
  ...
  //           <br />
  //           <h1 className="text-4xl">MRP : ₹{state.price * count}</h1>
  //           <br />
  //           <div>Qnt :{count}</div>
  //           <br />
...
<div className="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
  ...
  <div>
    ...
    <div className="space-y-6">
      <p className="text-base text-gray-900">{product.discretion}</p>
    </div>
  </div>
